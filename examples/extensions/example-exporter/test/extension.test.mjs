  ...
  const response = await new Promise((resolve, reject) => {
    ...
    child.stdin.write(JSON.stringify({
      ...
      params: {
        ...
        extensionId: 'example-exporter', extensionVersion: '1.0.0',
        grantedPermissions: {"specRead":true,"repositoryRead":false,"repositoryWrite":false,"network":false,"childProcess":false,"environmentVariables":[]},
      },
    }) + '\n');
  });
  child.kill();
  assert.equal(response.result.extensionId, 'example-exporter');
});
