...
An out-of-process runner adapter provided by the example-runner extension.

A SpecBridge **runner** extension.
...
```bash
specbridge extension install ./dist/example-runner-1.0.0.specbridge-extension.zip
specbridge extension show example-runner
specbridge extension enable example-runner --accept-permissions <hash-from-show>
```
