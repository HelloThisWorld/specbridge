...
async function buildSnapshots() {
  ...
  const snapshots = {
    ...
    'schema-versions.json': {
      ...
      builderPacketCompilation: orchestration.BUILDER_PACKET_COMPILATION_SCHEMA_VERSION,
    ...
    'orchestration-contract.json': {
      ...
      builderPacketCompilationFailures: [...orchestration.BUILDER_PACKET_COMPILATION_FAILURES].sort(),
      knowledgeStates: [...orchestration.KNOWLEDGE_STATES].sort(),
      decisionEntropies: [...orchestration.DECISION_ENTROPIES].sort(),
      implementationSpecificities: [...orchestration.IMPLEMENTATION_SPECIFICITIES].sort(),
      workReadinessVerificationStrengths: [...orchestration.WORK_READINESS_VERIFICATION_STRENGTHS].sort(),
      workReadinessContextStates: [...orchestration.WORK_READINESS_CONTEXT_STATES].sort(),
      repositoryMutationScopes: [...orchestration.REPOSITORY_MUTATION_SCOPES].sort(),
